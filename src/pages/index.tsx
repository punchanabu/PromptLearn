  ...
  export default function HomePage() {
    return (
      <Layout>
        <div className={`flex flex-col justify-between text-black ${inter.className} items-center`}>
          ...
          <main className="flex flex-col items-center justify-center mt-16">
            ...
            <motion.h1 
              ...
              className="text-6xl font-semibold mb-6 text-black text-center"
            >
              Elevate Your Knowledge <br></br>with AI-Driven Learning
            </motion.h1>
            <p className="max-w-prose text-lg text-center mb-8 text-black font-medium">Create personalized courses and notes with the power of AI.</p>

            {/* Call to Action Button */}
            <Link href="/courses/create" className="bg-black text-xl hover:bg-white-600 text-white font-bold py-4 px-8 rounded-xl transition duration-300 ease-in-out transform hover:scale-105">
          ...
          <section className="mt-16 grid grid-cols-1 gap-6 text-center lg:max-w-5xl lg:w-full lg:grid-cols-3 lg:text-left">
            <motion.div 
              ...
              className="feature-card space-y-4 shadow-md p-8 rounded-xl bg-gray-200 transition-colors duration-300"
            >
