        ...
        <Layout>
            <div className="flex flex-col md:grid md:grid-cols-2 p-10">
                <div className='p-10 space-y-12 '>
                    <div className='flex justify-center items-center flex-col shadow-md rounded-md p-10 max-w-xl space-y-5'>
                        <Image src={CreateSvg} alt="Create your notes" width={50} height={50}/> 
                    ...
                    <div className='flex justify-center items-center flex-col shadow-md rounded-md p-10 max-w-xl space-y-5'>
                        <Image src={UserSvg} alt="Create your notes" width={50} height={50}/> 
                ...
                <div className='p-10 space-y-10 flex flex-col items-center justify-center shadow-md rounded-md h-full'>
                    ...
                    <form className='space-y-10 flex items-center justify-center flex-col w-full'>
                        ...
                        <button 
                            type="submit"
                            className="bg-black text-white p-5 rounded-xl text-xl font-bold transition duration-300 hover:bg-gray-800"
